...
| change something that looks arbitrary | [docs/decisions/README.md](docs/decisions/README.md) — 101 decision records. Most exist because the obvious alternative was tried and cost something |
