...
What changed since: agent/checkin.sh:41-56 --at forwarded via gamereg_run. :208-221 'Exactly one sender... --deliver... is the only path', with --deliver always in the argument list and the reply flags optional. No mode switch exists. test/checkin-wrapper.test.ts:38-43, 302 (--at forwarded to every gamereg call).
