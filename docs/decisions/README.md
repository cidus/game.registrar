...
| [0107](0107-an-attachment-has-no-extension-to-vary.md) | An attachment has no extension to vary, so the derived artifacts stop carrying one | Build and targets | Accepted | 2026-09-24 |
...
- [0107](0107-an-attachment-has-no-extension-to-vary.md) An attachment has no extension to vary, so the derived artifacts stop carrying one
